...
// private fields
    ...
    public DoublyLinkedIntList() {
        // an empty node that have two sentinel (dummy) nodes as bookends
        pre = new Node();
        post = new Node();
    ...
    public void addBack(int value) {
        ...
        // Set up new Node and fill out (data, prev, next).
        ...
        // Go to th end of the list sentinel ad update its rev
        post.prev = theNewOne;
